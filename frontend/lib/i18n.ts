  ...
  en: {
    translation: {
      ...
      settings: {
        ...
        billingDescription: "Manage your Pro subscription, plan limits, and billing actions.",
        billingCardDescription: "Review your current plan quotas and subscription usage.",
        ...
        subscriptionCanceling: "Cancels at period end",
        billingLoading: "Loading billing details...",
        billingLoadError: "Unable to load billing details.",
        billingCheckoutSuccess: "Checkout completed. Your plan will update after Stripe confirms the subscription.",
        billingCheckoutCanceled: "Checkout was canceled. You can restart upgrade anytime.",
        billingError: "Unable to complete this billing action. Please try again.",
        ...
        quotaUsed: "{{used}} of {{limit}} used",
        freePlanSummary: "Free includes 10 shared units every 24 hours. Chat uses 1 unit and research uses 5 units.",
        proPlanSummary: "Pro includes 100 chat messages and 10 research runs every rolling 5 hours.",
        windowResets: "Window ends {{time}}",
        noSubscription: "No active Stripe subscription is connected.",
        stripeConnected: "Stripe customer connected",
        userId: "User ID",
  ...
  my: {
    translation: {
      ...
      settings: {
        ...
        subscriptionCanceling: "ကာလပြီးဆုံးချိန်တွင် ဖျက်သိမ်းမည်",
        billingLoading: "Billing အချက်အလက်များကို ဖွင့်နေသည်...",
        billingLoadError: "Billing အချက်အလက်များကို မဖွင့်နိုင်ပါ။",
        billingCheckoutSuccess: "Checkout ပြီးပါပြီ။ Stripe က subscription ကို အတည်ပြုပြီးသောအခါ plan အပ်ဒိတ်ဖြစ်ပါမည်။",
        billingCheckoutCanceled: "Checkout ကို ပယ်ဖျက်ထားသည်။ Upgrade ကို အချိန်မရွေး ပြန်စတင်နိုင်သည်။",
        billingError: "ဤ billing action ကို မပြီးမြောက်နိုင်ပါ။ ပြန်လည်ကြိုးစားပါ။",
        upgradeToPro: "Pro သို့ Upgrade လုပ်ရန်",
        cancelSubscription: "Subscription ဖျက်သိမ်းရန်",
        resumeSubscription: "Subscription ပြန်ဖွင့်ရန်",
        openingCheckout: "Checkout ကို ဖွင့်နေသည်...",
        updatingSubscription: "Subscription ကို အပ်ဒိတ်လုပ်နေသည်...",
        refresh: "ပြန်ဖွင့်ရန်",
        quotaUsage: "Quota အသုံးပြုမှု",
        quotaRemaining: "{{count}} ကျန်သေးသည်",
        quotaUsed: "{{used}} / {{limit}} အသုံးပြုပြီး",
        freePlanSummary: "Free တွင် ၂၄ နာရီတိုင်း shared unit ၁၀ ခု ပါဝင်သည်။ Chat သည် ၁ unit သုံးပြီး research သည် ၅ units သုံးသည်။",
        proPlanSummary: "Pro တွင် rolling ၅ နာရီတိုင်း chat message ၁၀၀ ခုနှင့် research run ၁၀ ခု ပါဝင်သည်။",
        windowResets: "Window ပြီးဆုံးချိန် {{time}}",
        noSubscription: "ချိတ်ဆက်ထားသော Stripe subscription မရှိပါ။",
        stripeConnected: "Stripe customer ချိတ်ဆက်ပြီး",
        userId: "User ID",
