  ...
  en: {
    translation: {
      ...
      composer: {
        ...
        chatRequiresResearch: "Start with Research to create a conversation before switching to Chat.",
      },
      conversation: {
      ...
      errors: {
        ...
        chatRequiresConversation: "Start a research conversation before sending chat follow-ups.",
      },
    },
  },
  my: {
    translation: {
      ...
      composer: {
        ...
        chatRequiresResearch: "Chat သို့မပြောင်းမီ conversation တစ်ခုဖန်တီးရန် Research ကို အရင်စတင်ပါ။",
      },
      conversation: {
      ...
      errors: {
        ...
        chatRequiresConversation: "Chat ဆက်မေးခွန်းများပို့မီ research conversation တစ်ခုကို အရင်စတင်ပါ။",
      },
    },
  },
} as const;
